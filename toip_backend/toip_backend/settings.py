"""
Django settings for toip_backend project.
...
SECRET_KEY = 'django-insecure-btsx$i^1ji0%l_rwsebs6t7=idk=u7te8q5jm@#=spo)1v0bb)'
...
# Ajoutez la configuration ASGI
ASGI_APPLICATION = 'toip_backend.asgi.application'

# Configurez les couches de canaux
CHANNEL_LAYERS = {
    'default': {
...
ROOT_URLCONF = 'toip_backend.urls'
...
WSGI_APPLICATION = 'toip_backend.wsgi.application'
